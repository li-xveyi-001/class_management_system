...
<!-- 表格 -->
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
               ...
               <el-table-column label="用户学号" align="center" key="userNumber" prop="userNumber" v-if="columns[1].visible" :show-overflow-tooltip="true" width="160"/>
               ...
               <el-table-column label="部门" align="center" key="deptName" prop="dept.deptName" v-if="columns[4].visible" :show-overflow-tooltip="true" width="160"/>
            ...
            <el-row>
               ...
               <el-col :span="12">
                  <el-form-item label="用户学号" prop="userNumber">
                     <el-input v-model="form.userNumber" placeholder="请输入用户学号" maxlength="30" />
                  </el-form-item>
               </el-col>
               <el-col :span="12">
...
const data = reactive({
  ...
  rules: {
   userNumber: [{ required: true, message: "用户学号不能为空", trigger: "blur" }, { min: 2, max: 20, message: "用户名称长度必须介于 2 和 20 之间", trigger: "blur" }],
